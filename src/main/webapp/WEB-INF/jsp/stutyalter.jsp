...
<div class="rightinfo">
    ...
    <div class="formbody1">
        ...
        <div class="formtitle"><span>修改学生体育成绩(姓名 班级 学期)</span></div>
		<form action="pe_tostutyalter.action">
	        <ul class="forminfo">
	        	<s:textfield name="id" type="hidden"></s:textfield>
	            <li><label>课程名</label><s:textfield name="pe.pname" cssClass="dfinput1"></s:textfield></li>
