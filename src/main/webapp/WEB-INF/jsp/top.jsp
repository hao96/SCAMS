...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
    <li><a href="login_main.action" target="rightFrame" class="selected"><img src="images/icon01.png" title="首页" /><h2>首页</h2></a></li>
    ...
    <li><a href="user_password.action"  target="rightFrame"><img src="images/icon06.png" title="用户管理" /><h2>用户管理</h2></a></li>
    </ul>
    ...
    <li><a href="#">关于</a></li>
    <li><a href="login_logout.action" target="_parent">退出</a></li>
    </ul>
