...
<div class="rightinfo">
    <div class="formbody">
		...
		<form action="pe_stutyselect.action">
        <ul class="forminfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
        <s:iterator value="#sps">
	        <tr>
	            <td><label>&nbsp;</label></td>
	            <td>${pe.pname }</td>
	            <td>${core }</td>
	            <td>${term }</td>
	            <td><a href="pe_stutyalter.action?id=${id }" class="tablelink">查看</a>     <a href="pe_delete.action?id=${id }" class="tablelink"> 删除</a></td>
	        </tr>
		</s:iterator>
