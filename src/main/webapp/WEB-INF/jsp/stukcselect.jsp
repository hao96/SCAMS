...
<div class="rightinfo">
    <div class="formbody">
		...
		<form action="kc_tostukcselect.action">
        <ul class="forminfo">
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>${core }</td>
            <td>${term }</td>
            <td><a href="kc_stukcalter.action?id=${id }" class="tablelink">查看并修改</a>     <a href="kc_delete.action?id=${id }" class="tablelink"> 删除</a></td>
        </tr>
		</s:iterator>
        </tbody>
    </table>
